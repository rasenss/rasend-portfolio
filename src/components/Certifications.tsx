            ...
            <div className="flex flex-col gap-6">
              ...
              <Tilt3D key={`${selectedOrg}-${searchQuery}-${cert.id}`} max={3} scale={1.015} className="w-full">
                <motion.div
                  ...
                  whileHover={{ y: -3 }}
                  className={`rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden transform-gpu will-change-[transform,opacity] transition-all duration-300 ${
                    isDark 
